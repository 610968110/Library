...
public enum Floors {
    ...
    FIRST_FLOOR(new Floor("1", "文明摇篮展厅", 1, R.drawable.floor_1, R.drawable.floor_test)) {
        ...
        public Floor addExhibits(Floor floor) {
            ...
            e1.setVoice(makeFileDir("test_voice.m4a"));
            e1.setVideo(makeFileDir("test_video.mp4"));
            ...
            e2.setVoice(makeFileDir("test_voice.m4a"));
            e2.setVideo(makeFileDir("test_video.mp4"));
...
//            }
    ...
    int centerW = XTools.WindowUtil().getScreenWidth() / 2;
    int centerH = XTools.WindowUtil().getScreenHeight() / 2;
    private Floor floor;
    ...
    private static String makeFileDir(String fileName) {
        return XTools.getApplicationContext().getFilesDir() + File.separator + fileName;
    }
}
